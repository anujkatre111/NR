...
export const RestaurantCard = ({resData}) => {
    ...
    return(
        <div className="res-card p-8 hover:p-10 w-[400px] min-h-[500px] rounded flex flex-col justify-between group transition-all ease-in-out duration-300">
...
export const withPromotedLabel = (RestaurantCard) => {
    return (props) => {
        return( 
            <div className="">
                <label className="absolute m-2 p-2 bg-green-700 text-white rounded">Open</label>
